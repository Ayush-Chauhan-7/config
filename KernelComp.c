...
void parallel_process_creator(int flag){
    ...
    if(flag==1){
        ...
        if(pid_child1==0){
            ...
            pro_time1=(e1.tv_sec-s1.tv_sec)+((e1.tv_nsec-s1.tv_nsec)/denom);
    ...
    if(flag==2){
        ...
        if(pid_child2==0){
            ...
            pro_time2=(e2.tv_sec-s2.tv_sec)+((e2.tv_nsec-s2.tv_nsec)/denom);
    ...
    if(flag==3){
        ...
        if(pid_child3==0){
            ...
            pro_time3=(e3.tv_sec-s3.tv_sec)+((e3.tv_nsec-s3.tv_nsec)/denom);
